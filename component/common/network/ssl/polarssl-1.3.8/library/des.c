                    ...
                    unsigned char *output )
{
    ...
    if(length > 0)
    {
        ...
        if(mode == DES_DECRYPT)
        {
            ...
            rtl_crypto_des_cbc_init(key_buf_aligned, DES_KEY_SIZE);
            rtl_crypto_des_cbc_decrypt(input, length, iv_buf_aligned, 8, output_buf_aligned);
            memcpy(iv, iv_tmp, 8);
        }
        else
        {
            ...
            rtl_crypto_des_cbc_init(key_buf_aligned, DES_KEY_SIZE);
            rtl_crypto_des_cbc_encrypt(input, length, iv_buf_aligned, 8, output_buf_aligned);
                     ...
                     unsigned char *output )
{
    ...
    if(length > 0)
    {
        ...
        if(mode == DES_DECRYPT)
        {
            ...
            memcpy(iv_tmp, (input + length - 8), 8);
            rtl_crypto_3des_cbc_init(key_buf_aligned, DES_KEY_SIZE * 3);
            rtl_crypto_3des_cbc_decrypt(input, length, iv_buf_aligned, 8, output_buf_aligned);
            memcpy(iv, iv_tmp, 8);
        }
        else
        {
            ...
            rtl_crypto_3des_cbc_init(key_buf_aligned, DES_KEY_SIZE * 3);
            rtl_crypto_3des_cbc_encrypt(input, length, iv_buf_aligned, 8, output_buf_aligned);
            memcpy(iv, (output_buf_aligned + length - 8), 8);
        }
