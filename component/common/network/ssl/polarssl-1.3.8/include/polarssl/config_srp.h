...
/**
 * \def POLARSSL_KEY_EXCHANGE_SRP_ENABLED
 *
 * Enable the SRP based ciphersuite modes in SSL / TLS.
 *
 * This enables the following ciphersuites (if other requisites are
 * enabled as well):
 *      TLS_SRP_WITH_AES_256_CBC_SHA
 */
#define POLARSSL_KEY_EXCHANGE_SRP_ENABLED
 ...
 * \def POLARSSL_SRP_C
 *
 * Enable the SRP library.
 *
 * Module:  library/srp.c
 * Caller:  library/ssl_cli.c
 */
#define POLARSSL_SRP_C
...
#define POLARSSL_MPI_MAX_SIZE             128 /**< Maximum number of bytes for usable MPIs. Default in 512.
                                                   POLARSSL_MPI_MAX_SIZE 128 for bignum and premaster size is only verified for SSL SRP handshake with group parameter of 1024 */
// CTR_DRBG options
//
...
// SSL options
//
#define SSL_MAX_CONTENT_LEN               512 /**< Size of the input / output buffer. Default in 16384.
                                                   SSL_MAX_CONTENT_LEN 512 is only verified for SSL SRP handshake */
...
#if defined(POLARSSL_KEY_EXCHANGE_SRP_ENABLED) && ( !defined(POLARSSL_SRP_C) )
#error "POLARSSL_KEY_EXCHANGE_SRP_ENABLED defined, but not all prerequisites"
#endif
